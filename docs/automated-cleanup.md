...
The real adapter is wired to `github.com/6ixfalls/ipadecrypt` at `v0.0.0-20260910224641-9e7d11de4bee`. It uses only the public `Decrypt`, `Cleanup`, `LoginWithMACAddress`, and `Verify` APIs.
