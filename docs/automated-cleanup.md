...
The real adapter is wired to `github.com/6ixfalls/ipadecrypt` at `v0.0.0-20260910090157-b91a95e6f1b4`. It uses only the public `Decrypt`, `Cleanup`, `LoginWithMACAddress`, and `Verify` APIs.
