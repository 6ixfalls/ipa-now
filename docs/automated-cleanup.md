...
The real adapter is wired to `github.com/6ixfalls/ipadecrypt` at `v0.0.0-20260911004001-2e9761dfea6d`. It uses only the public `Decrypt`, `Cleanup`, `LoginWithMACAddress`, and `Verify` APIs.
