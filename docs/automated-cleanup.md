...
The real adapter is wired to `github.com/6ixfalls/ipadecrypt` at `v0.0.0-20260908101951-c1b5e837cf72`. It uses only the public `Decrypt`, `Cleanup`, `LoginWithMACAddress`, and `Verify` APIs.
